...
public class Helper
{
	 ...
	 */
	public static class TextViewUndoRedo {
	...
	public static void listViewSearch(boolean init, Activity activity, final Filter filter) {
		if (init) {
			LayoutInflater inflater = LayoutInflater.from(activity);
			View view = inflater.inflate(R.layout.search, null);
			ViewGroup contentView = (ViewGroup) getContentView(activity);
			contentView.addView(view, 0);
			
			final EditText searchEdit = (EditText) activity.findViewById(android.R.id.edit);
        	...
        	final ViewGroup searchGroup = (ViewGroup) activity.findViewById(R.id.search);
        	searchGroup.setVisibility(View.GONE);
			ImageButton btn = (ImageButton) activity.findViewById(R.id.button1);
			if (btn != null)
...
//	    	alert(this, viewHierarchy(this));
		}
		else {
			ViewGroup searchGroup = (ViewGroup) activity.findViewById(R.id.search);
        	if (searchGroup.getVisibility() == View.VISIBLE)
        		searchGroup.setVisibility(View.GONE);
        	else {
        		searchGroup.setVisibility(View.VISIBLE);
        		activity.findViewById(android.R.id.edit).requestFocus();
        	}
		}
	}
}